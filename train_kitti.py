...
def train(options):
    ...
    for dset_path in options.dataset:
        ...
        data_sets.append(KITTIDataset(
            dset_path, 
            sequence=os.path.basename(os.path.normpath(dset_path)),
            num_points=1000, 
...
if __name__ == "__main__":
    ...
    PARSER.add_argument(
        "--dataset", default=["/home/neo/Epipolar_evaluation/dataset/01",
                              "/home/neo/Epipolar_evaluation/dataset/02",
                              "/home/neo/Epipolar_evaluation/dataset/03",
